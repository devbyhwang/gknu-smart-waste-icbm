...
class MotorC:
    ...
    def _attach_motors(self, initial_bottom=None, initial_top=None):
        self._detach_motors() # ⭐️ 핀 충돌(GPIOPinInUse) 방지를 위해 혹시 열려있는 연결 강제 종료
    ...
    def reset_motors(self):
        ...
        self._detach_motors() # ⭐️ 초기 위치로 복귀한 후 반드시 핀 연결을 해제(대기 상태)합니다.
    ...
    def process_item(self, received_value):
        ...
        self._detach_motors() # (여기는 기존에도 잘 짜여 있었습니다)
        print("[Motor] 분류 완료")
